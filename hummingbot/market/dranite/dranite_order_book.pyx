...
from hummingbot.core.data_type.order_book_message import (
    OrderBookMessage, OrderBookMessageType, DraniteOrderBookMessage
)
...
cdef class DraniteOrderBook(OrderBook):
    ...
    def snapshot_message_from_exchange(cls,
        ...
        if metadata:
            msg.update(metadata)
        return DraniteOrderBookMessage(
    ...
    def from_snapshot(cls, snapshot: OrderBookMessage):
        raise NotImplementedError("Dranite order book needs to retain individual order data.")
