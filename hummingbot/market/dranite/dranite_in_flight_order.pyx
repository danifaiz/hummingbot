...
cdef class DraniteMarket(MarketBase):
    ...
    def __init__(self,
        ...
        self._coinbase_auth = DraniteAuth(coinbase_pro_api_key, coinbase_pro_secret_key, coinbase_pro_passphrase)
        self._order_book_tracker = DraniteOrderBookTracker(data_source_type=order_book_tracker_data_source_type,
                                                           symbols=symbols)
        self._user_stream_tracker = DraniteUserStreamTracker(coinbase_pro_auth=self._coinbase_auth,
                                                             symbols=symbols)
    ...
    @property
    def coinbase_auth(self) -> DraniteAuth:
        """
        :return: DraniteAuth class (This is unique to coinbase pro market).
