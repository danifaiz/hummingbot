...
from hummingbot.core.data_type.order_book_tracker_entry import OrderBookTrackerEntry, DraniteOrderBookTrackerEntry
...
class DraniteAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def websocket_connection(self) -> (signalr_aio.Connection, signalr_aio.hubs.Hub):
        ...
        self._websocket_connection = signalr_aio.Connection(DRANITE_WS_FEED, session=None)
    ...
    async def get_tracking_pairs(self) -> Dict[str, OrderBookTrackerEntry]:
        ...
        for index, trading_pair in enumerate(trading_pairs):
            ...
            try:
                ...
                active_order_tracker: DraniteActiveOrderTracker = DraniteActiveOrderTracker()
                ...
                retval[trading_pair] = DraniteOrderBookTrackerEntry(
            ...
            try:
                async for raw_message in self._socket_stream():
                    ...
                    if decoded["type"] == "update":
                        ...
                        diff_msg: OrderBookMessage = DraniteOrderBook.diff_message_from_exchange(
