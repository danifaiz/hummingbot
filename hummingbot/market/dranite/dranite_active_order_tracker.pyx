...
DraniteOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]
...
cdef class DraniteActiveOrderTracker:
    def __init__(self,
                 active_asks: DraniteOrderBookTrackingDictionary = None,
                 active_bids: DraniteOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    def logger(cls) -> HummingbotLogger:
        global _daot_logger
        if _daot_logger is None:
            _daot_logger = logging.getLogger(__name__)
        return _daot_logger

    @property
    def active_asks(self) -> DraniteOrderBookTrackingDictionary:
        """
    ...
    @property
    def active_bids(self) -> DraniteOrderBookTrackingDictionary:
        """
