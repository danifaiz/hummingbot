...
class DraniteOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[DraniteOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: DraniteOrderBookTracker = DraniteOrderBookTracker(
    ...
    def test_tracker_integrity(self):
        ...
        test_order_book: OrderBook = order_books["ltc-btc"]
        ...
        test_active_order_tracker = self.order_book_tracker._active_order_trackers["ltc-btc"]
